...
var addToIncompleteList = function addToIncompleteList(text) {
  // li生成
  var li = document.createElement("li"); // p生成

  var p = document.createElement("p");
  p.innerText = text; // div生成

  var div = document.createElement("div"); // 完了ボタン生成
  ...
  completeButton.addEventListener("click", function () {
    ...
    deleteFromIncompleteList(completeTarget.parentNode); //完了リストに追加する要素

    var addTarget = completeTarget.parentNode; //追加する要素のテキストを取得

    var text = addTarget.firstChild.innerText; //追加する要素の中身を初期化

    addTarget.textContent = null; //todoリストに追加したときと同じように中身を生成する

    var p = document.createElement("p");
    p.innerText = text; //戻るボタン生成
    ...
    document.getElementById("complete-list").appendChild(addTarget); //戻すボタンの実装

    returnButton.addEventListener("click", function () {
      var returnTarget = returnButton.parentNode;
      deleteFromCompleteList(returnTarget);
      var text = returnTarget.firstChild.innerText;
  ...
  div.appendChild(deleteButton); // todoリストに追加
